...
import NextHeader from "../../Assets/images/Next/next-react.jpg";
    ...
    <>
      <Box sx={{ paddingTop: "90px" }}>
        ...
        <Grid container>
          ...
          <Grid item lg={7}>
            <Box>
              <img alt="" src={NextHeader} width={700} height={300} />
              <Grid container justifyContent="center" sx={{ mt: 2 }}>
                <Grid item lg={8}>
                  <Box sx={{ textAlign: "center" }}>
                    <Chip label="React" color="secondary" />
                    &nbsp;&nbsp;
                    <Chip label="Next" color="secondary" />
                    <br />
                    <br />
                  </Box>
              ...
              <List>
                <ListItem>
                  <ListItemButton onClick={() => scrollToRef(clientRef)} component="a" href="#client-side-rendering">
                    <ListItemText primary="Client Side rendering" />
                  </ListItemButton>
                </ListItem>
                <ListItem>
